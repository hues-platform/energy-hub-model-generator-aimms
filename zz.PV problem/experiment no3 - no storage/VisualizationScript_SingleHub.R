...
setwd("C:\\Users\\Raphaela\\Dropbox\\MASTER THESIS\\Model\\Model Case study\\Operating model ori prpol\\Operating Model\\aimms_model\\energy_hub\\results")
...
results_total_income  <- data.frame(technology=character(),total_cost=numeric(),experiment=character())
...
for(experiment in experiments) {
  ...
  data = read.xlsx(filename,"Output_energy_Elec")
  ...
  #We are interested in heat but the excel file has the word cool instead of heat
  data_stor <- data.frame(data_stor$Cool)
