...
if print_demand_data == 1
    ...
    if multiple_hubs == 0
        ...
        for h = 1:number_of_hubs
            demand_data_for_printing = strcat(demand_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_demands.xlsx","Energy_demands_hub',num2str(h),'");');
            demand_data_for_printing = strcat(demand_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_demands.xlsx",Energy_demands(t,x,''',num2str(h),'''),"B2:',char('A' + length(energy_outputs) - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + length(energy_outputs) - 1 + 1),'1","Energy_demands_hub',num2str(h),'",0,1,1);');
        end
    end
...
if print_conversion_data == 1 && isempty(unique_technologies.conversion_techs_names) == 0
    ...
    if multiple_hubs == 0
        ...
        for h = 1:number_of_hubs
            conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_conversion.xlsx","Input_energy_hub',num2str(h),'");');
            conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_conversion.xlsx",Input_energy(t,conv,''',num2str(h),'''),"B2:',char('A' + number_of_conversion_techs - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + number_of_conversion_techs - 1 + 1),'1","Input_energy_hub',num2str(h),'",0,1,1);');
            conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_conversion.xlsx","Exported_energy_renewable_hub',num2str(h),'");');
            conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_conversion.xlsx",Exported_energy_renewable(t,x,''',num2str(h),'''),"B2:',char('A' + length(energy_outputs) - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + length(energy_outputs) - 1 + 1),'1","Exported_energy_renewable_hub',num2str(h),'",0,1,1);');
            conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_conversion.xlsx","Exported_energy_nonrenewable_hub',num2str(h),'");');
            conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_conversion.xlsx",Exported_energy_nonrenewable(t,x,''',num2str(h),'''),"B2:',char('A' + length(energy_outputs) - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + length(energy_outputs) - 1 + 1),'1","Exported_energy_nonrenewable_hub',num2str(h),'",0,1,1);');
            if consider_electricity_demand == 1
                conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_conversion.xlsx","Output_energy_electricity_hub',num2str(h),'");');
                conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_conversion.xlsx",Output_energy_electricity(t,conv,''',num2str(h),'''),"B2:',char('A' + number_of_conversion_techs - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + number_of_conversion_techs - 1 + 1),'1","Output_energy_electricity_hub',num2str(h),'",0,1,1);');
            end
            if consider_heating_demand == 1
                conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_conversion.xlsx","Output_energy_heat_hub',num2str(h),'");');
                conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_conversion.xlsx",Output_energy_heat(t,conv,''',num2str(h),'''),"B2:',char('A' + number_of_conversion_techs - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + number_of_conversion_techs - 1 + 1),'1","Output_energy_heat_hub',num2str(h),'",0,1,1);');
            end
            if consider_cooling_demand == 1
                conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_conversion.xlsx","Output_energy_cool_hub',num2str(h),'");');
                conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_conversion.xlsx",Output_energy_cool(t,conv,''',num2str(h),'''),"B2:',char('A' + number_of_conversion_techs - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + number_of_conversion_techs - 1 + 1),'1","Output_energy_cool_hub',num2str(h),'",0,1,1);');
            end
            if consider_dhw_demand == 1
                conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_conversion.xlsx","Output_energy_dhw_hub',num2str(h),'");');
                conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_conversion.xlsx",Output_energy_dhw(t,conv,''',num2str(h),'''),"B2:',char('A' + number_of_conversion_techs - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + number_of_conversion_techs - 1 + 1),'1","Output_energy_dhw_hub',num2str(h),'",0,1,1);');
            end
            if consider_anergy_demand == 1
                conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_conversion.xlsx","Output_energy_anergy_hub',num2str(h),'");');
                conversion_data_for_printing = strcat(conversion_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_conversion.xlsx",Output_energy_anergy(t,conv,''',num2str(h),'''),"B2:',char('A' + number_of_conversion_techs - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + number_of_conversion_techs - 1 + 1),'1","Output_energy_anergy_hub',num2str(h),'",0,1,1);');
            end
        end
    end
...
if print_storage_data == 1 && isempty(unique_technologies.storage_techs_names) == 0
    ...
    if multiple_hubs == 0
        ...
        for h = 1:number_of_hubs
            storage_data_for_printing = strcat(storage_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_storage.xlsx","Storage_input_energy_hub',num2str(h),'");');
            storage_data_for_printing = strcat(storage_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_storage.xlsx","Storage_output_energy_hub',num2str(h),'");');
            storage_data_for_printing = strcat(storage_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_storage.xlsx","Storage_SOC_hub',num2str(h),'");');
            if simplified_storage_representation == 1
                storage_data_for_printing = strcat(storage_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_storage.xlsx",Storage_input_energy(t,x,''',num2str(h),'''),"B2:',char('A' + number_of_storage_techs - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + number_of_storage_techs - 1 + 1),'1","Storage_input_energy_hub',num2str(h),'",0,1,1);');
                storage_data_for_printing = strcat(storage_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_storage.xlsx",Storage_output_energy(t,x,''',num2str(h),'''),"B2:',char('A' + number_of_storage_techs - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + number_of_storage_techs - 1 + 1),'1","Storage_output_energy_hub',num2str(h),'",0,1,1);');
                storage_data_for_printing = strcat(storage_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_storage.xlsx",Storage_SOC(t,x,''',num2str(h),'''),"B2:',char('A' + number_of_storage_techs - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + number_of_storage_techs - 1 + 1),'1","Storage_SOC_hub',num2str(h),'",0,1,1);');
            else
                storage_data_for_printing = strcat(storage_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_storage.xlsx",Storage_input_energy(t,stor,''',num2str(h),'''),"B2:',char('A' + number_of_storage_techs - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + number_of_storage_techs - 1 + 1),'1","Storage_input_energy_hub',num2str(h),'",0,1,1);');
                storage_data_for_printing = strcat(storage_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_storage.xlsx",Storage_output_energy(t,stor,''',num2str(h),'''),"B2:',char('A' + number_of_storage_techs - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + number_of_storage_techs - 1 + 1),'1","Storage_output_energy_hub',num2str(h),'",0,1,1);');
                storage_data_for_printing = strcat(storage_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_storage.xlsx",Storage_SOC(t,stor,''',num2str(h),'''),"B2:',char('A' + number_of_storage_techs - 1 + 1),num2str(number_of_timesteps + 1),'","A2:A',num2str(number_of_timesteps + 1),'","B1:',char('A' + number_of_storage_techs - 1 + 1),'1","Storage_SOC_hub',num2str(h),'",0,1,1);');
            end
        end
    end
...
if print_installation_data == 1 && select_techs_and_do_sizing == 1
    ...
    if multiple_hubs == 0
        ...
        if isempty(unique_technologies.conversion_techs_names) == 0
            installation_data_for_printing = strcat(installation_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_capacities.xlsx",Installation,"B2:',char('A' + number_of_conversion_techs - 1 + 1),num2str(length(energy_outputs) + 1),'","A2:A',num2str(length(energy_outputs) + 1),'","B1:',char('A' + number_of_conversion_techs - 1 + 1),'1","Installation",0,1,1);');
            installation_data_for_printing = strcat(installation_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_capacities.xlsx",Capacity,"B2:',char('A' + number_of_conversion_techs - 1 + 1),num2str(length(energy_outputs) + 1),'","A2:A',num2str(length(energy_outputs) + 1),'","B1:',char('A' + number_of_conversion_techs - 1 + 1),'1","Capacity",0,1,1);');
        end
        if isempty(unique_technologies.storage_techs_names) == 0
        ...
        for h = 1:number_of_hubs
            installation_data_for_printing = strcat(installation_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_capacities.xlsx","Installation_hub',num2str(h),'");');
            installation_data_for_printing = strcat(installation_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_capacities.xlsx","Capacity_hub',num2str(h),'");');
            installation_data_for_printing = strcat(installation_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_capacities.xlsx","Storage_capacity_hub',num2str(h),'");');
            installation_data_for_printing = strcat(installation_data_for_printing,'\n\t\t\tSpreadsheet::AddNewSheet("results/',experiment_name,'/results_capacities.xlsx","Installation_storage_hub',num2str(h),'");');
            if isempty(unique_technologies.conversion_techs_names) == 0
                installation_data_for_printing = strcat(installation_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_capacities.xlsx",Installation(x,conv,''',num2str(h),'''),"B2:',char('A' + number_of_conversion_techs - 1 + 1),num2str(length(energy_outputs) + 1),'","A2:A',num2str(length(energy_outputs) + 1),'","B1:',char('A' + number_of_conversion_techs - 1 + 1),'1","Installation_hub',num2str(h),'",0,1,1);');
                installation_data_for_printing = strcat(installation_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_capacities.xlsx",Capacity(x,conv,''',num2str(h),'''),"B2:',char('A' + number_of_conversion_techs - 1 + 1),num2str(length(energy_outputs) + 1),'","A2:A',num2str(length(energy_outputs) + 1),'","B1:',char('A' + number_of_conversion_techs - 1 + 1),'1","Capacity_hub',num2str(h),'",0,1,1);');
            end
            if isempty(unique_technologies.storage_techs_names) == 0
                if simplified_storage_representation == 1
                    installation_data_for_printing = strcat(installation_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_capacities.xlsx",Storage_capacity(x,''',num2str(h),'''),"B1:B',num2str(number_of_storage_techs),'","A1:A',num2str(number_of_storage_techs),'","","Storage_capacity_hub',num2str(h),'",0,1,3);');
                    installation_data_for_printing = strcat(installation_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_capacities.xlsx",Installation_storage(x,''',num2str(h),'''),"B1:B',num2str(number_of_storage_techs),'","A1:A',num2str(number_of_storage_techs),'","","Installation_storage_hub',num2str(h),'",0,1,3);');
                else
                    installation_data_for_printing = strcat(installation_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_capacities.xlsx",Storage_capacity(x,stor,''',num2str(h),'''),"B1:B',num2str(number_of_storage_techs),'","A1:A',num2str(number_of_storage_techs),'","","Storage_capacity_hub',num2str(h),'",0,1,3);');
                    installation_data_for_printing = strcat(installation_data_for_printing,'\n\t\t\tSpreadsheet::AssignTable("results/',experiment_name,'/results_capacities.xlsx",Installation_storage(x,stor,''',num2str(h),'''),"B1:B',num2str(number_of_storage_techs),'","A1:A',num2str(number_of_storage_techs),'","","Installation_storage_hub',num2str(h),'",0,1,3);');
                end
            end  
        end
    end
